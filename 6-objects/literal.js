...
//I couldn't decide which answer seemed better, so here you go, have two:

prime.print = function(){return this.address + ", " + this.city + ", " + this.state + " " + this.zip;}
prime.print();

prime.print = console.log(prime.address + ", " + prime.city + ", " + prime.state + " " + prime.zip);
